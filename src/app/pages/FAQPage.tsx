...
const generalFaq: FAQItem[] = [
  {
    ...
    a: <>Don't Sleep With The Fishes is a sea-themed point-and-click survival horror game by DopplerGhost. You play as a captain whose ship has been damaged — quickly salvage items into a lifeboat, choose one crew member, then survive day-by-day by fishing, eating, repairing, and handling night events. The game has multiple endings.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official itch.io page</span></>,
  },
  {
    q: "How do I download and install the game?",
    a: <>Purchase the game ($1.99) on the official itch.io page. After purchase, click the <strong>Download</strong> button at the top of the itch page to get the Windows executable.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official itch.io page &amp; community download instructions</span></>,
  },
  {
    q: "What platform is the game on?",
    a: <>Currently <strong>Windows only</strong>. The official itch page lists the platform as Windows. No native Mac, Linux, or mobile versions exist at this time.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official itch.io page</span></>,
  },
  {
    q: "Is Don't Sleep With The Fishes coming to Steam?",
    a: <>Yes, a <strong>Steam port is planned</strong>. The v1.1.2 devlog states that a Steam port is the developer's next major goal. However, no specific release date has been announced. The devlog also mentions custom Steam achievements may be added with the Steam version.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official v1.1.2 devlog</span></>,
  },
  {
    q: "Will itch.io buyers get a Steam key?",
    a: <>This has <strong>not been confirmed</strong> by the developer. Some game developers do provide Steam keys to itch.io purchasers after a Steam release, but this is not guaranteed. Wait for an official announcement from DopplerGhost.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(251,191,36,0.7)" }}>Source: Not yet confirmed — community speculation</span></>,
  },
  {
    q: "Can I get the game for free?",
    a: <>This guide does not provide or link to pirated copies. The game costs <strong>$1.99 on itch.io</strong> and supports an independent developer. If you cannot afford it, wishlist it and watch for sales or the Steam release.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official itch.io pricing</span></>,
  },
];
...
const gameplayFaq: FAQItem[] = [
  ...
  },
  {
    ...
    a: <>The official itch page confirms <strong>multiple endings</strong> but does not give an exact number. Community reports suggest 12+ distinct outcomes, including rescue, death, and hidden endings. See the{" "}
      ...
      for the full breakdown with source confidence labels.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official (multiple endings confirmed) + Community (specific count)</span></>,
  },
  {
    ...
    a: <>Use <strong>Flare Gun or Flashlight</strong> during the Hope and Other People night events. The rescue ending chance was slightly increased in v1.1.2. See the{" "}
      ...
      for details.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official v1.1.2 devlog (rescue chance increased) + Community (flare/flashlight method)</span></>,
  },
  {
    ...
    a: <>Captain Whiskers is a cat crew member. In <strong>v1.1.2</strong>, Captain Whiskers gives a <strong>+1% fishing catch chance</strong> bonus. The cat also has unique lore interactions. See the{" "}
      ...
      (coming soon).<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official v1.1.2 devlog</span></>,
  },
  {
    ...
    a: <>The Giant Squid is a night event that can destroy your boat. One <strong>community reply on Reddit says to use the Anchor</strong>. Harpoon Gun is also mentioned as a possible counter but is unverified. This event may be connected to the Pay Debt and True Ending routes. See the{" "}
      <Link href="/events/giant-squid" className="underline hover:text-amber">Giant Squid Guide</Link>.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(251,191,36,0.7)" }}>Source: Community (Reddit) — not independently verified</span></>,
  },
  {
    ...
    a: <>This is a game mechanic that <strong>community players are still tracking</strong>. It appears to be connected to the Giant Squid encounter and possibly the Heart of the Sea / Heart Piece items. No confirmed resolution steps exist yet. See the{" "}
      <Link href="/endings/pay-debt" className="underline hover:text-amber">Pay Debt tracker page</Link>.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(251,191,36,0.7)" }}>Source: Community (Reddit discussions) — route not confirmed</span></>,
  },
  {
    ...
    a: <>Players on Reddit have reported finding Heart Note and Heart Piece items, but their <strong>purpose is not yet confirmed</strong>. Community theories suggest they may relate to a hidden route or the True Ending. We are tracking this — see the{" "}
      <Link href="/items/heart-of-the-sea" className="underline hover:text-amber">Heart of the Sea page</Link>.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(239,68,68,0.7)" }}>Source: Unverified — player reports only</span></>,
  },
  {
    q: "Does Message in a Bottle do anything?",
    a: <>Players on Reddit have asked about this item's purpose. Currently, <strong>its function is unknown</strong>. If you discover what it does, the community would benefit from your report.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(239,68,68,0.7)" }}>Source: Unverified — player questions only</span></>,
  },
  {
    q: "What is the world record for days survived?",
    a: <>No official world record exists. Reddit players have self-reported <strong>52, 68, and 75 days survived</strong>, but these are unverified claims without evidence standards. v1.1.2 added a "Highest Day Reached" record to the game.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(52,211,153,0.7)" }}>Source: Official (record feature added) + Unverified (player day counts)</span></>,
  },
  {
    q: "Is there a Chinese or Korean translation?",
    a: <>No official Chinese or Korean translation exists. Community translation patches may be available — check community forums — but these are <strong>unofficial and may have compatibility issues</strong> with current game versions. Always download from trusted sources.<br /><br /><span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(251,191,36,0.7)" }}>Source: Community — no official translations</span></>,
  },
];
        ...
        <div className="mb-10">
          <div className="mb-3 flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-2 rounded-full px-3 py-1.5" style={{ background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.18)" }}>
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-amber">FAQ</span>
            </span>
