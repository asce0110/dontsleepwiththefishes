              ...
              <table className="w-full text-left" style={{ borderCollapse: "collapse", minWidth: 600 }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid rgba(245,158,11,0.09)" }}>
                    ...
                    <th className="py-2.5 pr-3 text-xs font-black uppercase tracking-widest text-text-secondary hidden sm:table-cell" style={NUNITO}>When to Use</th>
                    <th className="py-2.5 pr-3 text-xs font-black uppercase tracking-widest text-text-secondary hidden md:table-cell" style={NUNITO}>Expected Result</th>
                ...
                <tbody>
                  {counterTable.map((row, i) => (
                    <tr key={row.item} style={{ borderBottom: i < counterTable.length - 1 ? "1px solid rgba(245,158,11,0.06)" : "none" }}>
